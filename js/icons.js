/* Stroke-Icons (Lucide-Stil, ISC) als Inline-SVG – theme-fähig über currentColor. */
window.Vamos = window.Vamos || {};

Vamos.icons = (function () {
  var PATHS = {
    ...
    reader: '<path d="M2 6h4"/><path d="M2 10h4"/><path d="M2 14h4"/><path d="M2 18h4"/><rect width="12" height="18" x="8" y="3" rx="1"/><path d="M11 7h6"/><path d="M11 11h6"/>',
  ...
  function svg(name, cls) {
    var p = PATHS[name];
    if (!p) return "";
    return '<svg class="icn ' + (cls || "") + '" viewBox="0 0 24 24" aria-hidden="true">' + p + "</svg>";
  }
